  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 text-white placeholder-white/30 focus:outline-none focus:border-[#F5C518]"
              placeholder={focused.password ? '' : 'Enter your password'}
              required
            />
            <button
              type="button"
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 text-white/50 text-sm cursor-pointer">
            <input
              ...
              className="rounded border-white/20 bg-white/5 accent-[#F5C518]"
            />
            Keep me logged in
          </label>
          <Link to="/forgot-password" className="text-[#F5C518] text-sm hover:underline">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="text-white/50 text-sm text-center mt-6">
        ...
        <Link to="/sign-up" className="text-[#F5C518] hover:underline">
          Sign Up
        </Link>
      </p>
    </div>
