...
export default function SignUp() {
  ...
  return (
    <div>
      ...
      <p className="text-white/50 mb-6">Create your  Smart Study Planner account</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder={focused.firstName ? '' : 'firstname'}
              required
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#F5C518]"
              placeholder={focused.lastName ? '' : 'last name'}
              required
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder={focused.password ? '' : 'Minimum 8 characters'}
              required
            />
            <button
              type="button"
